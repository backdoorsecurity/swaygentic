...
public class VernacularConfig {
    ...
    private Consumer<Bitmap> screenUpdateListener;
    private Consumer<Void> bellListener;
    private Consumer<String> remoteClipboardListener;
    private BiConsumer<Bitmap, Point> mousePointerUpdateListener;
    ...
    public Consumer<Bitmap> getScreenUpdateListener() {
     ...
     *
     * @param screenUpdateListener A Consumer which will receive Bitmaps representing the updated remote desktop
     * @see android.graphics.Bitmap Bitmap
     */
    public void setScreenUpdateListener(Consumer<Bitmap> screenUpdateListener) {
        this.screenUpdateListener = screenUpdateListener;
    }

    public BiConsumer<Bitmap, Point> getMousePointerUpdateListener() {
     ...
     * screen).
     *
     * @param mousePointerUpdateListener A Consumer which will receive Bitmaps representing the updated cursor shape
     * @see android.graphics.Bitmap Bitmap
     */
    public void setMousePointerUpdateListener(BiConsumer<Bitmap, Point> mousePointerUpdateListener) {
